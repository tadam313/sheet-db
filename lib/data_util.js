...
module.exports = {
    ...
    /**
     * Tries to convert the value in the "most appropriate" form. Since we can not decide the type of the data coming back from
     * the spreadsheet data, we try to coerce it to number.
     *
     * @param value
     * @returns {*}
     */
    coerceNumber: function(value) {
        ...
        if (this.isNaN(numberValue) || isInt.test(value)) {
