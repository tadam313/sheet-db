...
var getOperationContext = function() {
 ...
 */
 var getContext = function(operation_type, options) {
    ...
    var ctx = getOperationContext()[operation_type];
...
module.exports = {
     ...
     */
     querySheetInfo: function(sheetId, callback) {
        var key = data_util.createIdentifier('sheet_info', sheetId);
     ...
     */
     queryWorksheet: function(workSheetInfo, query, options, callback) {
        var key = data_util.createIdentifier(workSheetInfo.worksheetId, JSON.stringify(query)),
        orderBy, reverse;
     ...
     */
     queryFields: function(workSheetInfo, callback) {
        var key = data_util.createIdentifier('queryFields', workSheetInfo.worksheetId);
