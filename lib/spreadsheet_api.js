...
var OPERATION_CONTEXTS = {
    ...
    'sheet_info': {
        url: 'https://spreadsheets.google.com/feeds/worksheets/{sheetId}/{visibility}/full?alt=json',
        method: 'GET'
    },
    ...
    'remove_worksheet': {
        url: 'https://spreadsheets.google.com/feeds/worksheets/{sheetId}/{visibility}/full/{worksheetId}/version?alt=json',
        method: 'GET'
    },

    'create_entry': {
        url: 'https://spreadsheets.google.com/feeds/list/{sheetId}/{worksheetId}/{visibility}/full?alt=json',
        method: 'POST',
        headers: {
            'Content-Type': 'application/atom+xml'
        }
    ...
    'query_worksheet': {
        url: 'https://spreadsheets.google.com/feeds/list/{sheetId}/{worksheetId}/{visibility}/full?alt=json&{filter}{sort_column}{sort_direction}',
        method: 'GET'
    },

    'delete_entry': {
        url: 'https://spreadsheets.google.com/feeds/list/{sheetId}/{worksheetId}/{visibility}/full/{rowId}?alt=json',
        method: 'DELETE'
    }
};
...
var getContext = function(operation_type, options) {
    ...
    ctx.url = tpl.parse(ctx.url).expand(options) + (token ? '&access_token=' + token : '');
...
var handleResponse = function (transformation, callback, err, body) {
    ...
    try {
        convertedData = typeof transformation === 'function' ? transformation(body) : c.convertGeneric(body);
    }
    catch (err) {
...
module.exports = {
    ...
    dropWorksheet: function(sheetId, worksheetId, callback) {
        executeRequest('remove_worksheet', {
            ...
            handleResponse.bind({}, c.dropWorksheetResponse, callback));
    },
    ...
    insertEntry: function(worksheetId, entry, callback) {
        ...
        executeRequest('create_entry', {
            ...
            handleResponse.bind({}, c.createEntryResponse, callback));
    },
     ...
     * @param callback
     */
    queryWorkSheet: function(worksheetId, options, callback) {
        var key = worksheetId + JSON.stringify(options);
