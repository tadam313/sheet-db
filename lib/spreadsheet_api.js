...
var OPERATION_CONTEXTS = {
    ...
    'query_worksheet': {
        url: 'https://spreadsheets.google.com/feeds/list/{sheetId}/{worksheetId}/{visibility}/full?alt=json&{query}{sort_column}{sort_direction}',
        method: 'GET'
    },
...
module.exports = {
     ...
     * @param callback
     */
    queryWorkSheet: function(worksheetId, query, callback) {
