...
Worksheet.prototype.createColumns = function(fields, callback) {
    ...
    this.listColumns(function(err, result) {
        ...
        columnCreator.call(_this, fields, result, callback);
    });
};

/**
 * Calculates diff of the array and invoked the column creation logic.
 *
 * @param {array} newColumns Array of field names
 * @param {array} actualColumns Actual columns in the worksheet
 * @param {function} callback
 */
function columnCreator(newColumns, actualColumns, callback) {
