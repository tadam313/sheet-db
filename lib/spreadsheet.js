...
Spreadsheet.prototype.worksheet = function(title, callback) {
    ...
    if (!callback) {
        throw new Error('If you have never invoked sheetInfo before calling worksheets, callback' +
            ' is required parameter! Please consider using the standard factory instantiating' +
            ' this object!');
    }
