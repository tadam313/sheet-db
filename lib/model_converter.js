...
module.exports = {
     ...
     */
    worksheetResponse: function(worksheet) {
        return {
     ...
     *
     * @param entry
     * @returns {{$id: *, $updated: Date}}
     */
    worksheetEntryResponse: function(entry) {
    ...
    sheetInfoResponse: function(rawData) {
        ...
        return {
            ...
            workSheets: feed.entry.map(this.worksheetResponse.bind(this)),
    ...
    createWorksheetResponse: function(rawData) {
        ...
        return this.worksheetResponse(entry);
    },
     ...
     * @returns {null}
     */
    dropWorksheetResponse: function(rawData) {
        return null;
    },
    ...
    queryResponse: function(rawData) {
        ...
        return entry.map(this.worksheetEntryResponse.bind(this));
    }
};
